...
extern int nivel_atual;      // Nível atual do reservatório
extern int bomba_estado;      // Estado da bomba (0 = desligada, 1 = ligada)
extern int limite_min;       // Limite mínimo
extern int limite_max;       // Limite máximo
